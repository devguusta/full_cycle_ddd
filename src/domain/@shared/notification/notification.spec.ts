...
describe("Unit tests for notifications", () => {
    ...
    it("should filter messages by context errors", () => {
        const notification = new Notification();
        const error = {
            message: "error message",
            context: "customer",
    ...
    it("should return all messages when doesnt have context", () => {
        const notification = new Notification();
        const error = {
            message: "error message",
            context: "customer",
        ...
        expect(notification.messages()).toBe("customer: error message,customer: error message2,");
        const error3 = {
            message: "error message3",
            context: "order",
        };
